...
#   -> 정규표현식 사용
#   -> re를 import 하여 이메일 입력값 내 '@' 존재 여부 파악 ex: @naver.com
#   -> 아이디는 최소 5글자여야 하며, 
#   -> 첫 글자는 영어 소문자만 가능, 두 번째 글자부터 영어 소문자, 숫자, 언더바(_) 가능
#   -> 위의 패턴이 안 맞는 경우 재입력 하도록 함
...
# - 이전 페이지 조회(P)의 경우, 첫 번째 페이지인 상태에서 이전 페이지로 이동이 불가하므로 현재 페이지인 첫 번째 페이지를 반환
...
import re
custlist=[]
custlist = [{'name': '유1', 'gender': 'M', 'email': 's12341@naver.com', 'birthday': '2000'},
            {'name': '유2', 'gender': 'M', 'email': 's12342@naver.com', 'birthday': '2000'},
            {'name': '유3', 'gender': 'M', 'email': 's12343@naver.com', 'birthday': '2000'},
            {'name': '유4', 'gender': 'M', 'email': 's12344@naver.com', 'birthday': '2000'}]
page=3
